        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['category_id'])) {
                    ...
                    $msgForDeleteFirstPart = 'Are you sure you wan\'t to delete a ';
                    $msgForDeleteSecondPart = ' category? All stores which is assigned to this category will delete.';
                    $item[$name]['delete'] = [
                        'href' => $hrefForDelete,
                        'label' => __('Delete'),
                        'confirm' => [
                            'title' => __('Delete '.$item['name']),
                            'message' => __($msgForDeleteFirstPart.$item['name'].$msgForDeleteSecondPart)
                        ]
                    ];
                }
            }
