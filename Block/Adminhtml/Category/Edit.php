...
namespace Acme\StoreLocator\Block\Adminhtml\Category;
...
class Edit extends Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Acme_StoreLocator';
    ...
    public function getHeaderText()
    {
        if ($this->coreRegistry->registry('storelocator_category')->getId()) {
            return __(
                "Edit Category '%1'",
                $this->escapeHtml($this->coreRegistry->registry('storelocator_category')->getName())
            );
        } else {
