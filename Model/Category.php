...
namespace Acme\StoreLocator\Model;
...
class Category extends AbstractModel implements CategoryInterface, IdentityInterface
{
    ...
    const CACHE_TAG = 'acme_storelocator_category';
    ...
    public function __construct(
        ...
        $this->_cacheTag = 'acme_storelocator_category';
        $this->_eventPrefix = 'acme_storelocator_category';
